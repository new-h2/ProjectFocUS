					...
					<% checkmNo = 1; %>
						<div class="board-btn-box">
							<div class="board-btn-wrap">
								<input type="submit" value="상품 수정" class="board-btn" id="submit">
				...
				<div class="donation-content-wrap">
						...
						<div class="donation-content-donation">
							<div class="donation-content-donation-now">
								...
								<div style="display: flex; justify-content: space-between;">
									<div class="donation-btn btn" id="bag">장바구니</div>
									<div class="donation-btn btn">구매하기</div>
									<div class="like_btn">
										<% if(like != null) { %>
								...
								<div style="border-top: 2px solid lightgray; margin-top: 25px;"></div>
							</div>
						</div>
					</div>
					...
					<div class="goods-content-middle">
						<div class="goods_choose_view">
							...
							<div class="goods_choose_view_btn" id="review"><p class="detail_btn">리뷰</p></div>
						</div>
