...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.ArrayList, board.model.vo.*,  donation.model.vo.*, like.model.vo.Likey"%>
<%
				...
				<div class="donation-content-top">
					...
					<div class="donation-content-donation">
						...
						<div class="donation_btn_box">
							...
							<div class="donation_btn donation_update"><input type ="submit" value="수정하기"></div>
							<div class="donation_btn donation_delete"><input type ="button" onclick ="deleteBoard();" value="삭제하기"></div>
								<% } %>
							...
							<div class="donation-cotent-like">
								<% if(ly!=null){ %>
										<div class="like"><i class="fas fa-heart donation_heart"></i></div>
										<% } else{ %>
										<div class="like"><i class="far fa-heart donation_heart"></i></div>
										<% } %>									
							...
							<div class="donation-content-real">
								...
								<div class="donation-goal">
									<p class="donation-nowgoal"><span id="comma2"><%= d.getdPay() %></span>원 목표</p>
									<input type="hidden" name="hiddenDPeriod" value="<%= d.getdPeriod() %>">
									<input type="hidden" name="hiddenDPay" value="<%= d.getdPay() %>">
								</div>
								<div class="donation-btn btn" onclick="goDonationPay();" id="donationPay">후원하기</div>
...
<!-- 						</div> -->
					...
					<div class="donation-content-bottom-flex">
						...
						<input type="button" value="작성하기" class="donation-content-bottom-submit" id="donation-Reply">
					</div>
	...
	<script>
		...
		$('.like').on('click', function(){
			...
			if($(this).children().attr('class') == 'far fa-heart donation_heart') {
				$.ajax({
					...
					context: this,
			  		success: function(data) {
						if(data[0] == 1) {		
							$(this).children().attr('class', 'fas fa-heart donation_heart');
				...
				$.ajax({
					...
					success: function(data) {
						if(data[0] == 1) {		
							$(this).children().attr('class', 'far fa-heart donation_heart');
							$(this).parent().children().eq(1).text(data[1]);
						}
					}
				});
