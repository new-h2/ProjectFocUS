...
<!-- 					</div> -->
					<div class="payment_finally_wrap total_price">
						...
						<div class="payment_price"><input type="text" name="dPay" onkeyup="inputNumberFormat(this)" style="text-align:right;"></div>
					</div>

					<div class="payment_finally_line"></div> 

					<div class="payment_btn" id="donationKakaoPay"><input type="submit" value="후원하기"></div>
				</div>
            </div>
					</form>
        </div>
