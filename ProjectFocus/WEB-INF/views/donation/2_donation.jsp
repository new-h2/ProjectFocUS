<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.ArrayList, board.model.vo.*,  donation.model.vo.Donation, common.*"%>
<%
...
<body>
	...
	<div class="main_poster_container">
		<div class="board_main_image_box">
			<img src="image/focus_donation_main.jpg" class="donation_main_image">
		</div>
	</div>
...
<!-- 				</div> -->
			...
			<div class="hashtag_and_search">
				...
				<form>
					...
					<input type="button" value="검색" class="btn_sty btn" >
				</form>
			</div>
		</div>
					...
					<input type="hidden" value="<%= b.getbNo() %>">
						...
						<div class="main_box_top">
							...
							<div class="main_box_top_likey">
								...
								<div class="main_likey_total" style="font-size:9px; margin-top:8px"><%= b.getbLike() %>개</div>
							</div>
						</div>
