...
<body class="body-write">
    <header class="header">
        <div class="header-box">
            ...
            <button class="submitBtn btn" onclick="submit();" value="등록하기">등록하기</button>
        </div>
    </header>
    <main>
        ...
        <div class="post-container">
            ...
            <form action="<%= request.getContextPath()%>/insertService.bo" method="post" encType="multipart/form-data">
                <div class="area-wrap">
                    <div class="OOTC">
                       <div class="input-container">
                           <div class="input-wrap">
                               <input type="text" class="OOTC-input input-title" placeholder="제목을 입력하세요." name="title">
                               <select name="category" id="category">
                                   <option value="10">청소</option>
                                   <option value="20">산책</option>
                                   <option value="30">돌봄</option>
                                   <option value="40">재능기부</option>
                                   <option value="50">기타</option>
                               </select>
                           </div>
                            <div class="input-wrap">
                                <input type="text" class="OOTC-input input-place" placeholder="장소를 입력하세요." id="location" name="location"  onclick="findPostcode();" readonly>
                                <input type="hidden" id="postcode" name="postcode">
                                <input type="hidden" id="xAddress" name="xlocation">
								<input type="hidden" id="yAddress" name="ylocation">
                                <input type="text" class="OOTC-input input-time" placeholder="시간을 입력하세요." name="time">
                            </div>
                            <div class="input-wrap input-wrap2">
                                <input type="text" id="note" class="OOTC-input input-note" placeholder="특이사항을 입력하세요." name="etc">
<!--                                 <div class="imageBtn"> -->
<!--                                 <input type="button" value="지도" onclick="open_map(mapServlet?)"> -->
<!--                                 </div> -->
                            </div>
                       </div>
                    </div>
                    ...
                    <div class="area">
                        <textarea name="content" id="content-area" placeholder="내용을 입력하세요."></textarea>
