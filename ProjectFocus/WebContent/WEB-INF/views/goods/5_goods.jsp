...
<body>
	...
	<div class="main_poster_container">
		<div class="board_main_image_box">
			<img src="image/focus_goods_main.jpg" class="goods_main_image">
		</div>
	</div>
	...
	<main class="goods_main">
		<form class="search_form">
			...
			<input type="button" value="상품 등록" class="btn_sty btn" style="margin-left: 10px;"onclick="location.href='<%= request.getContextPath() %>/goodsWrite.go'">
			<% } %>
		</form>	
			...
			<% for(int i = 0; i < bList.size(); i++) { %>
				...
				<div class="content">
					...
					<% for(int j = 0; j < iList.size(); j++) { %>
						...
						<% } %>
					<% } %>
					<div class="goods_product_name"><span><%= b.getbTitle() %></span></div>
